...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Add City</h1>
                ...
                <form method="post" action="{{ url('admin/city') }}">
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <th>Provinsi</th>
                            <td>
                                <select name="provincy_id" id="province" class="form-control" required>
                        ...
                        <tr>
                            <th>Kota</th>
                            <td><input  name="city_name" type="text" class="form-control"></td>
                        </tr>
                        <tr>
                            <td colspan="2">
