                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-dark">Create New
                                <a href="{{ url('admin/province/') }}" class="float-right">back</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" action="{{ url('admin/province') }}">
                                    @csrf
                                    <table class="table table-bordered">
                                        <tr>
                                            <th>Province</th>
                                            <td><input name="provincy_name" type="text" class="form-control"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
